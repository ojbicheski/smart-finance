package com.smartfinance.client.template.config;
...
public class TemplateConfig {
  ...
  @Bean
  public WebClient template(TemplateProperties properties) {
  ...
  private ExchangeFilterFunction logRequest() {
    return ExchangeFilterFunction.ofRequestProcessor(clientRequest -> {
      log.info("Template {} - {}", clientRequest.method(), clientRequest.url());
  ...
  private ExchangeFilterFunction logResponse() {
    return ExchangeFilterFunction.ofResponseProcessor(response -> {
      log.info("Operator#Template HTTP Status Code: {}", response.statusCode());
