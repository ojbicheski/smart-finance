package com.smartfinance.client.customer.config;
...
public class CustomerConfig {
  ...
  @Bean
  public WebClient customer(CustomerProperties properties) {
  ...
  private ExchangeFilterFunction logRequest() {
    return ExchangeFilterFunction.ofRequestProcessor(clientRequest -> {
      log.info("Preference {} - {}", clientRequest.method(), clientRequest.url());
  ...
  private ExchangeFilterFunction logResponse() {
    return ExchangeFilterFunction.ofResponseProcessor(response -> {
      log.info("Customer#Preference#Country HTTP Status Code: {}", response.statusCode());
